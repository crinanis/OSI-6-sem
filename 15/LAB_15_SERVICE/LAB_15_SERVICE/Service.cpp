...
VOID WINAPI ServiceMain(DWORD dwArgc, LPTSTR* lpszArgv)
{
	...
	else
	{
		...
		{
			int k = 0;
			system("d:\\1POIT\\3\\OSI\\labs\\ОССП_Лабораторная_работа_14 (4 часа)\\lab5-ht-user-com-dll\\x64\\Debug\\OS14_START.exe d:\\1POIT\\3\\OSI\\labs\\ОССП_Лабораторная_работа_14 (4 часа)\\lab5-ht-user-com-dll\\storage\\HTspace.ht HTUser01 1234");
...
VOID WINAPI ServiceHandler(DWORD fdwControl)
{
	...
	case SERVICE_CONTROL_SHUTDOWN:
		...
		ServiceStatus.dwCheckPoint = 0;
		ServiceStatus.dwWaitHint = 0;
		system("d:\\1POIT\\3\\OSI\\labs\\ОССП_Лабораторная_работа_14 (4 часа)\\lab5-ht-user-com-dll\\storage\\OS14_STOP.exe ");
		break;
